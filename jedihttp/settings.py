...
default_settings = {
    'case_insensitive_completion': jedi.settings.case_insensitive_completion,
    'add_bracket_after_function': jedi.settings.add_bracket_after_function,
    ...
    'additional_dynamic_modules': jedi.settings.additional_dynamic_modules,
